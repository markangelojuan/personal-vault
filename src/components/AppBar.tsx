...
const AppBar = () => {
  ...
  return (
    <header className="bg-gray-900/90 text-white p-4 flex items-center justify-between shadow-lg md:p-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="bg-yellow-600 hover:bg-yellow-700 text-white px-3 py-1 rounded-md text-sm cursor-pointer md:px-4 md:py-2"
        >
          Logout
        </button>
      </div>
